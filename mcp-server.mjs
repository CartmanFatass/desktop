...
registerTool(
  'agentify_review_query',
  {
    ...
    inputSchema: {
      ...
      productModel: z.string().describe('Exact provider product-model label as shown in the open picker. Current ChatGPT target (6 Pro): GPT-6 Astra or its checked label Latest.'),
